...
export const FUSION_DONORS: Record<FusionEffectType, FusionDonorMeta> = {
  ...
  'beam-pulse': {
    effectType: 'beam-pulse',
    name: 'Beam Pulse (Border Beam)',
    sourceComponentName: 'Border Beam',
    sourceComponentType: 'border-beam',
    tagline: 'Glow perimetral que viaja ou respira na borda',
    description: 'Extraido do Libraries.dev border-beam: feixe conico que contorna a borda (rotate) ou pulso suave (pulse-inner/outside), com palettes colorful/mono/ocean/sunset.',
    badge: 'Libraries.dev',
    icon: 'Zap',
    color: '#22d3ee',
    availableFeatures: [
      { id: 'rotate-beam', label: 'Feixe Viajante', description: 'Gradiente cônico que orbita o contorno' },
      { id: 'pulse-breathe', label: 'Respiração Pulso', description: 'Glow que pulsa sem rotação (família pulse)' },
      { id: 'line-sweep', label: 'Varredura Linear', description: 'Brilho que corre apenas na aresta inferior' },
    ],
    compatibleSlots: [
      { slot: 'border', label: 'Borda / Stroke', description: 'Anel de luz perimetral animado' },
      { slot: 'after-shine', label: 'Camada ::after', description: 'Varredura especular na borda' },
      { slot: 'before-glow', label: 'Camada ::before', description: 'Aura respirando atrás do elemento' },
      { slot: 'badge', label: 'Badge / Chip', description: 'Contorno luminoso em pills e tags' },
    ],
  },

  'orb-loader': {
    effectType: 'orb-loader',
    name: 'Orb Loader (Thinking Orbs)',
    sourceComponentName: 'Thinking Orb',
    sourceComponentType: 'thinking-orb',
    tagline: 'Orbe pontilhado de raciocínio para IA',
    description: 'Extraido do Libraries.dev thinking-orbs: halo orbital pontilhado com nove estados de loading que comunicam processamento do agente.',
    badge: 'Libraries.dev',
    icon: 'Brain',
    color: '#a78bfa',
    availableFeatures: [
      { id: 'dotted-halo', label: 'Halo Pontilhado', description: 'Anel de pontos em órbita animada' },
      { id: 'state-verbs', label: '9 Verbos de Estado', description: 'working/searching/solving/listening…' },
      { id: 'reduced-motion', label: 'Frame Estático', description: 'Respects prefers-reduced-motion' },
    ],
    compatibleSlots: [
      { slot: 'badge', label: 'Badge / Status', description: 'Substitui o badge por um orbe de status' },
      { slot: 'icon', label: 'Ícone', description: 'Indicador de raciocínio no lugar do glifo' },
      { slot: 'border', label: 'Borda', description: 'Halo pontilhado contornando o componente' },
      { slot: 'before-glow', label: 'Camada ::before', description: 'Aura de processamento atrás do conteúdo' },
    ],
  },

  'bot-face': {
    effectType: 'bot-face',
    name: 'Bot Face (Bot Avatars)',
    sourceComponentName: 'Bot Avatar',
    sourceComponentType: 'bot-avatar',
    tagline: 'Rosto vivo de bot com piscar e estados',
    description: 'Extraido do Libraries.dev bot-avatars: expressões animadas (olhos, boca, hop) com 18 formas e estados idle/working/sleeping.',
    badge: 'Libraries.dev',
    icon: 'Bot',
    color: '#34d399',
    availableFeatures: [
      { id: 'living-eyes', label: 'Olhos Vivos', description: 'Piscar, olhar e seguir o ponteiro' },
      { id: 'state-rig', label: 'Rig de Estados', description: 'Idle, working (hop) e sleeping com crossfade' },
      { id: 'plastic-shading', label: 'Shading Plástico', description: 'Iluminação por pixel em canvas 2D' },
    ],
    compatibleSlots: [
      { slot: 'icon', label: 'Ícone / Glifo', description: 'Rosto de bot animado no lugar do ícone' },
      { slot: 'badge', label: 'Badge', description: 'Mini-avatar pulsando na etiqueta' },
      { slot: 'active-item', label: 'Item Ativo', description: 'Item selecionado ganha expressão viva' },
    ],
  },

  'voice-beam': {
    effectType: 'voice-beam',
    name: 'Voice Beam (Voice Glow)',
    sourceComponentName: 'Voice Beam',
    sourceComponentType: 'voice-beam',
    tagline: 'Brilho que sobe com a voz na borda inferior',
    description: 'Extraido do Libraries.dev voice-glow: stroke + inner glow + bloom de 7 lobos que reagem ao nível de áudio ou ao respiro idle, com modo processing.',
    badge: 'Libraries.dev',
    icon: 'AudioLines',
    color: '#f472b6',
    availableFeatures: [
      { id: 'seven-lobes', label: '7 Lobos Cromáticos', description: 'Paleta derivada do tema GodUI' },
      { id: 'audio-reactive', label: 'Reativo a Áudio', description: 'AnalyserNode RMS ou level manual' },
      { id: 'processing-sweep', label: 'Sweep Processing', description: 'Feixe percorre a borda enquanto processa' },
    ],
    compatibleSlots: [
      { slot: 'border', label: 'Borda inferior', description: 'Glow de voz na aresta do componente' },
      { slot: 'background', label: 'Fundo', description: 'Brilho que preenche a base do container' },
      { slot: 'before-glow', label: 'Camada ::before', description: 'Aura vocal atrás do elemento' },
      { slot: 'main-container', label: 'Container Principal', description: 'Superfície inteira reage à voz' },
    ],
  },

  'metal-rim': {
    effectType: 'metal-rim',
    name: 'Metal Rim (Metal FX)',
    sourceComponentName: 'Metal FX',
    sourceComponentType: 'metal-fx',
    tagline: 'Metal líquido iridescente com órbita especular',
    description: 'Extraido do Libraries.dev metal-fx: anel conico metálico (chromatic/silver/gold) com sheen em órbita, luz de cursor e variantes text/badge.',
    badge: 'Libraries.dev',
    icon: 'Sparkles',
    color: '#c4b5fd',
    availableFeatures: [
      { id: 'conic-ring', label: 'Anel Cônico', description: 'Gradiente metálico contínuo na borda' },
      { id: 'orbit-sheen', label: 'Sheen em Órbita', description: 'Highlight especular girando no anel' },
      { id: 'cursor-light', label: 'Luz de Cursor', description: 'Brilho localizado segue o ponteiro' },
      { id: 'metal-text', label: 'Texto Metálico', description: 'Gradiente clipped nos glifos' },
    ],
    compatibleSlots: [
      { slot: 'border', label: 'Borda / Stroke', description: 'Anel de metal líquido no contorno' },
      { slot: 'active-item', label: 'Item Ativo', description: 'Seleção com moldura metálica' },
      { slot: 'badge', label: 'Badge', description: 'Pill com rim metálico' },
      { slot: 'interactive-items', label: 'Botões', description: 'Todos os botões ganham aro metálico' },
      { slot: 'icon', label: 'Ícone', description: 'Glifo com material metálico' },
    ],
  },

  'pixel-reveal': {
    effectType: 'pixel-reveal',
    name: 'Pixel Reveal (Image FX)',
    sourceComponentName: 'Image Generation',
    sourceComponentType: 'image-generation',
    tagline: 'Mosaico de pixels que se dissolve em imagem',
    description: 'Extraido do Libraries.dev img-fx: loader de mosaico com flicker que revela imagens célula a célula — presets organic, mechanic e sweep.',
    badge: 'Libraries.dev',
    icon: 'Image',
    color: '#2dd4bf',
    availableFeatures: [
      { id: 'pixel-mosaic', label: 'Mosaico de Pixels', description: 'Cells com tamanho em CSS px invariante' },
      { id: 'auto-reveal', label: 'Auto Reveal', description: 'Loop idle → reveal → visible → hide' },
      { id: 'sweep-gradient', label: 'Sweep Gradient', description: 'Varredura diagonal estilo "gerando"' },
    ],
    compatibleSlots: [
      { slot: 'background', label: 'Fundo / Container', description: 'Superfície vira mosaico gerativo' },
      { slot: 'border', label: 'Borda', description: 'Contorno pixelado pulsante' },
      { slot: 'content', label: 'Conteúdo', description: 'Corpo do componente com textura de pixels' },
      { slot: 'main-container', label: 'Container Principal', description: 'Card inteiro no modo revelação' },
    ],
  },

  'gooey-morph': {
    effectType: 'gooey-morph',
    name: 'Gooey Morph (Liquid Gooey)',
    sourceComponentName: 'Liquid Gooey',
    sourceComponentType: 'gooey-fab',
    tagline: 'Morph/move líquido com silhueta separada do conteúdo',
    description: 'Extraido do Libraries.dev liquid-gooey: arquitetura de camada-silhueta com filtro goo — itens se fundem ao tocar, texto permanece nítido, springs component-driven.',
    badge: 'Libraries.dev',
    icon: 'Droplet',
    color: '#c084fc',
    availableFeatures: [
      { id: 'silhouette-layer', label: 'Camada Silhueta', description: 'Filtro goo só na sombra; DOM real nítido acima' },
      { id: 'bouncy-springs', label: 'Springs Bouncy', description: 'Transições snappy/smooth/bouncy em transform' },
      { id: 'bridge-on-touch', label: 'Ponte ao Contato', description: 'blur controla a distância de fusão' },
    ],
    compatibleSlots: [
      { slot: 'active-item', label: 'Item Ativo', description: 'Indicador ativo estica como gota' },
      { slot: 'interactive-items', label: 'Itens Interativos', description: 'Botões vizinhos se fundem no hover' },
      { slot: 'main-container', label: 'Container', description: 'Superfície com tensão superficial líquida' },
      { slot: 'background', label: 'Fundo', description: 'Massa viscosa atrás do conteúdo' },
    ],
  },
};
...
export function getComponentSignatureEffect(type: GodUIComponentType): FusionEffectType {
  const map: Partial<Record<GodUIComponentType, FusionEffectType>> = {
    ...
    'thinking-orb': 'orb-loader',
    'bot-avatar': 'bot-face',
    'voice-beam': 'voice-beam',
    'metal-fx': 'metal-rim',
    'image-generation': 'pixel-reveal',
  };
...
export const FUSION_PRESETS: FusionPreset[] = [
  ...
  {
    id: 'preset-card-beam-pulse',
    name: 'Card com Border Beam na Borda',
    targetComponentType: 'spotlight-card',
    donorEffect: 'beam-pulse',
    targetSlot: 'border',
    description: 'O feixe perimetral do Libraries.dev border-beam contorna o card com glow que viaja ou respira.',
    intensity: 0.9,
    badge: 'Libraries.dev',
    withShimmer: true,
  },
  {
    id: 'preset-toolbar-metal-rim',
    name: 'Toolbar com Metal Rim no Item Ativo',
    targetComponentType: 'floating-toolbar',
    donorEffect: 'metal-rim',
    targetSlot: 'active-item',
    description: 'A ferramenta selecionada ganha moldura de metal líquido iridescente com sheen em órbita.',
    intensity: 0.95,
    badge: 'Libraries.dev',
  },
  {
    id: 'preset-prompt-voice-beam',
    name: 'Composer com Voice Beam',
    targetComponentType: 'prompt-composer',
    donorEffect: 'voice-beam',
    targetSlot: 'border',
    description: 'A borda inferior do composer acende com o brilho reativo à voz do Libraries.dev voice-glow.',
    intensity: 0.9,
    badge: 'Libraries.dev',
  },
];
